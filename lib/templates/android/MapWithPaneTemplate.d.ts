...
export type MapWithPaneTemplateConfig = AndroidNavigationBaseTemplateConfig & Omit<PaneTemplateConfig, 'actions' | 'onActionButtonPressed'> & {
    /**
 ...
 */
export declare class MapWithPaneTemplate extends AndroidNavigationBaseTemplate<MapWithPaneTemplateConfig> {
    config: MapWithPaneTemplateConfig;
    get type(): string;
    constructor(config: MapWithPaneTemplateConfig);
}
//# sourceMappingURL=MapWithPaneTemplate.d.ts.map