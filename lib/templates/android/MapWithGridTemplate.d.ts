...
export type MapWithGridTemplateConfig = AndroidNavigationBaseTemplateConfig & Omit<GridTemplateConfig, 'actions' | 'onButtonPressed' | 'buttons'> & {
    /**
 ...
 */
export declare class MapWithGridTemplate extends AndroidNavigationBaseTemplate<MapWithGridTemplateConfig> {
    get type(): string;
}
//# sourceMappingURL=MapWithGridTemplate.d.ts.map