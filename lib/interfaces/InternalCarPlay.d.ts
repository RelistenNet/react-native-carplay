...
export interface InternalCarPlay extends NativeModule {
     ...
     * @namespace Android
     */
    alert(config: Omit<AndroidAutoAlertConfig, 'actions'> & {
        actions?: Action[];
    }): void;
    /**
     * @namespace Android
     ...
     * @namespace Android
     */
    requestPermissions: (permissions: Array<string>, message: string, primaryAction: Action, headerAction: HeaderAction) => Promise<PermissionRequestResult>;
    /**
     * @namespace Android
     */
    getPlayServicesAvailable: () => Promise<boolean>;
}
//# sourceMappingURL=InternalCarPlay.d.ts.map