...
export type AndroidClusterConfig = Omit<ClusterConfig, 'inactiveDescriptionVariants' | 'onZoomIn' | 'onZoomOut' | 'onDidChangeCompassSetting' | 'onDidChangeSpeedLimitSetting'>;
export type OnClusterControllerConnectCallback = ({ id }: {
    id: string;
}) => void;
...
export declare enum InstrumentClusterSetting {
    Unspecified = 0,
    Enabled = 1,
    Disabled = 2,
    UserPreference = 3
