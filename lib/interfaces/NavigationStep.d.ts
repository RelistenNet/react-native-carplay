...
export declare enum CarIconSpanAlignment {
    ALIGN_BOTTOM = 0,
    ALIGN_BASELINE = 1,
    ALIGN_CENTER = 2
}
export type NavigationTrip = {
    steps?: Array<NavigationStep & {
        stepTravelEstimate: AndroidTravelEstimates;
    }>;
...
type BaseManeuver = {
    type: Exclude<AndroidAutoManeuverType, AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CW | AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CCW | AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CW_WITH_ANGLE | AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CCW_WITH_ANGLE>;
    image: ImageSourcePropType;
};
type RoundaboutManeuver = {
    type: AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CW | AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CCW;
    roundaboutExitNumber: number;
    image: ImageSourcePropType;
};
type RoundaboutWithAngleManeuver = {
    type: AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CW_WITH_ANGLE | AndroidAutoManeuverType.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CCW_WITH_ANGLE;
    roundaboutExitNumber: number;
    roundaboutExitAngle: number;
    image: ImageSourcePropType;
};
export type AndroidAutoManeuver = BaseManeuver | RoundaboutManeuver | RoundaboutWithAngleManeuver;
export declare enum AndroidAutoManeuverType {
    TYPE_UNKNOWN = 0,
    TYPE_DEPART = 1,
    TYPE_NAME_CHANGE = 2,
    TYPE_KEEP_LEFT = 3,
