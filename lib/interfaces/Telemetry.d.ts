...
export type AndroidAutoPermissions = Permission | 'com.google.android.gms.permission.CAR_FUEL' | 'com.google.android.gms.permission.CAR_SPEED' | 'com.google.android.gms.permission.CAR_MILEAGE' | 'android.car.permission.CAR_ENERGY' | 'android.car.permission.CAR_INFO' | 'android.car.permission.CAR_EXTERIOR_ENVIRONMENT' | 'android.car.permission.CAR_ENERGY_PORTS' | 'android.car.permission.CAR_SPEED';
